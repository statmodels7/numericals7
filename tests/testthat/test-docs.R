...
test_that("every exported topic has a value and an executable example", {
  ...
  dir <- man_dir(); skip_if(is.null(dir), "man/ not reachable from here")
  info <- rd_info(dir)
  exported <- getNamespaceExports(asNamespace("numericals7"))
  ...
  # \value; asking it for one would be asking what `?numericals7` returns.
